...
import { Eye, EyeOff, Plane, Lock, Mail, ArrowRight } from "lucide-react";
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4 md:space-y-6">
            ...
            <motion.div variants={itemVariants}>
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 md:py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
          ...
          <motion.div variants={itemVariants} className="mt-6 md:mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to TripPlanner?</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <p className="text-sm text-blue-800 text-center">
              <strong>Demo:</strong> Use any valid email and password to test
            </p>
          </motion.div>
        </motion.div>
