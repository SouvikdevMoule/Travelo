          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl font-medium transition-all duration-200 flex-shrink-0 min-w-[80px] sm:min-w-0 sm:flex-1 text-center justify-center ${
                  activeTab === tab.id
